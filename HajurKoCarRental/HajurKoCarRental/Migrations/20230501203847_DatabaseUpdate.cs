        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DrivingLicense = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    DrivingLicenseFileName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CitizenPaper = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    CitizenPaperFileName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarDamage_Rental_RentalID",
                        column: x => x.RentalID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notification_Rental_RentalID",
                        column: x => x.RentalID,
                        principalTable: "Rental",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
